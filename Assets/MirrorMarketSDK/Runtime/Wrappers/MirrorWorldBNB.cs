...
namespace MirrorWorld
{
    ...
    {
        //Wallet
        public void GetTransactions(double number, Action<string> action)
        {
            MWEVMWrapper.GetTransactions(number, action);
        }

        public void GetTransactionsByWallet(string wallet_address, int limit, Action<string> action)
        {
        ...
        public void TransferETH(string nonce, string gasPrice, string gasLimit, string to, string amount, Action approveFinished, Action<string> callBack)
        {
            MWEVMWrapper.TransferETH(nonce, gasPrice, gasLimit, to, amount, approveFinished, callBack);
        }

        public void TransferBNB(string nonce, string gasPrice, string gasLimit, string to, string amount, Action approveFinished, Action<string> callBack)
        {
            MWEVMWrapper.TransferBNB(nonce, gasPrice, gasLimit, to, amount, approveFinished, callBack);
        }

        public void TransferMatic(string nonce, string gasPrice, string gasLimit, string to, string amount, Action approveFinished, Action<string> callBack)
        {
    ...
    public class BNBAsset
    {
        ...
        public void CancelListing(string collection_address, int token_id, string marketplace_address, Action approveFinished, Action<string> callBack)
        {
        ...
        public void TransferNFT(string collection_address, int token_id, string to_wallet_address, Action approveAction, Action<string> callBack)
        {
            MWEVMWrapper.TransferNFT(collection_address, token_id, to_wallet_address, approveAction, callBack);
        }

        //Asset/Mint
        public void MintCollection(string collectionName, string collectionSymbol, string NFTDetailJson, Action approveFinished, Action<string> callBack)
        {
            MWEVMWrapper.MintCollection(collectionName, collectionSymbol, NFTDetailJson, approveFinished, callBack);
        }

        public void MintNFT(string collection_address, int token_id, string to_wallet_address, int mint_amount, string confirmation, Action approveFinished, Action<string> callBack)
        {
            MWEVMWrapper.MintNFT(collection_address, token_id, to_wallet_address, mint_amount, confirmation, approveFinished, callBack);
        }

        //Asset/Search
        public void QueryNFT(string mintAddress, string token_id, Action<string> action)
        {
            MWEVMWrapper.QueryNFT(mintAddress, token_id, action);
        }

        public void SearchNFTsByOwner(string owner_address, int limit, string cursor, Action<string> action)
        {
            MWEVMWrapper.SearchNFTsByOwner(owner_address, limit, cursor, action);
        }

        public void SearchNFTsByMintAddress(List<EVMSearchNFTsByAddressesReqToken> tokens, Action<string> callBack)
        {
